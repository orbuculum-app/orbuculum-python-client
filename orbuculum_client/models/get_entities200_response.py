...
class GetEntities200Response(BaseModel):
    """
    GetEntities200Response
    """ # noqa: E501
    status: Optional[StrictInt] = None
    data: Optional[GetEntities200ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": GetEntities200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
