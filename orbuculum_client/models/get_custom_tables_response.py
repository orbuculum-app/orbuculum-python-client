...
class GetCustomTablesResponse(BaseModel):
    ...
    data: Optional[Dict[str, CustomTableInfo]] = Field(default=None, description="Object containing custom table information (table name as key)")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": dict(
                (_k, CustomTableInfo.from_dict(_v))
