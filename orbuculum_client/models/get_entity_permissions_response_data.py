...
class GetEntityPermissionsResponseData(BaseModel):
    """
    Permissions grouped by type
    """ # noqa: E501
    permissions: Optional[GetEntityPermissionsResponseDataPermissions] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "permissions": GetEntityPermissionsResponseDataPermissions.from_dict(obj["permissions"]) if obj.get("permissions") is not None else None
        })
        return _obj
