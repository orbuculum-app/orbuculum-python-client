...
class ActivateEntity200Response(BaseModel):
    """
    ActivateEntity200Response
    """ # noqa: E501
    status: Optional[StrictInt] = None
    data: Optional[ActivateEntity200ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": ActivateEntity200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
