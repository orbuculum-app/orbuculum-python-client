...
class CreateEntityRequest(BaseModel):
    ...
    type: Optional[StrictInt] = Field(default=None, description="Entity type (optional, defaults to 2 - regular account)")
    __properties: ClassVar[List[str]] = ["workspace_id", "name", "type"]
