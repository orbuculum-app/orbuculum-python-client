...
class DeleteEntity200Response(BaseModel):
    """
    DeleteEntity200Response
    """ # noqa: E501
    status: Optional[StrictInt] = None
    data: Optional[DeleteEntity200ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": DeleteEntity200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
