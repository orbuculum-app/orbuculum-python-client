...
class GetLabelPermissionsResponseData(BaseModel):
    """
    Permissions grouped by type
    """ # noqa: E501
    permissions: Optional[GetLabelPermissionsResponseDataPermissions] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "permissions": GetLabelPermissionsResponseDataPermissions.from_dict(obj["permissions"]) if obj.get("permissions") is not None else None
        })
        return _obj
