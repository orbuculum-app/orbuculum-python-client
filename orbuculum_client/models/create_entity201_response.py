...
class CreateEntity201Response(BaseModel):
    """
    CreateEntity201Response
    """ # noqa: E501
    status: Optional[StrictInt] = None
    data: Optional[CreateEntity201ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": CreateEntity201ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
